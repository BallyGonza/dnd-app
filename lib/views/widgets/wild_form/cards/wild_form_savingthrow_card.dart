...
class WildFormSavingThrowCard extends StatefulWidget {
  ...
  @override
  State<WildFormSavingThrowCard> createState() =>
      _WildFormSavingThrowCardState();
}

class _WildFormSavingThrowCardState extends State<WildFormSavingThrowCard> {
  @override
          ...
          children: <Widget>[
            ...
            Wrap(
              ...
              children: [
                ...
                if (widget.savingThrow.modifier < 0)
                  const SizedBox(
                    width: 1.2,
                  )
                else
                ...
                const SizedBox(width: 5),
                if (widget.savingThrow.proficiency)
                  CircleAvatar(
