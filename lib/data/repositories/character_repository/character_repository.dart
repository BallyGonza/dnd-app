...
Character theekVarus = Character(
  ...
  skills: [
    ...
    Skill(name: 'T. con Animales', modifier: 9, proficiency: true),
  ],
  pets: [ghost],
...
Character vaunea = Character(
  ...
  skills: [
    ...
    Skill(name: 'T. con Animales', modifier: 1, proficiency: false),
  ],
...
Character evendurGreycastle = Character(
  ...
  skills: [
    ...
    Skill(name: 'T. con Animales', modifier: 0, proficiency: false),
  ],
  weapons: [],
